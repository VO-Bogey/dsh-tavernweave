    ...
    function UpdateTab({ state }) {
      ...
      return react.createElement("div", null,
        react.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", gap: "8px", marginBottom: "8px" } },
          react.createElement("div", null, react.createElement("strong", { style: { fontSize: "15px" } }, "更新中心"), react.createElement("div", { style: { color: "var(--dsw-alias-label-tertiary)", fontSize: "12px", marginTop: "3px" } }, "检查并更新 TavernWeave DSH 插件。原作者资料由维护者先同步到我们的版本。")),
        ...
        react.createElement("div", { style: { marginTop: "10px", color: "var(--dsw-alias-label-tertiary)", fontSize: "11px", lineHeight: 1.5 } }, "更新插件代码后通常需要重新加载 DSH 插件；原作者资料库的同步与版本合并由维护者完成，不会覆盖您的角色卡项目。"));
    }
