      ...
      return react.createElement("div", { style: { display: "inline-flex", alignItems: "center", gap: "5px", marginLeft: "4px" }, "aria-label": "Soul 人格选择" },
        ...
        SOUL_PERSONAS.map((persona) => {
          ...
          return react.createElement("span", { key: persona.id, style: { position: "relative", display: "inline-flex" },
            ...
            hovered === persona.id && react.createElement("div", { role: "tooltip", style: { position: "absolute", zIndex: 1001, left: "50%", bottom: "calc(100% + 7px)", transform: "translateX(-50%)", width: "min(270px, calc(100vw - 30px))", padding: "7px", borderRadius: "10px", border: "1px solid " + persona.tone + "55", background: "var(--dsw-specific-menu, var(--dsw-alias-bg-base))", color: "var(--dsw-alias-label-primary)", boxShadow: "var(--dsw-shadow-lv2)", fontSize: "11px", lineHeight: 1.35, pointerEvents: "auto" } },
    ...
    function UpdateTab({ state }) {
      ...
      return react.createElement("div", null,
        react.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", gap: "8px", marginBottom: "8px" } },
          react.createElement("div", null, react.createElement("strong", { style: { fontSize: "15px" } }, "更新中心"), react.createElement("div", { style: { color: "var(--dsw-alias-label-tertiary)", fontSize: "12px", marginTop: "3px" } }, "同步插件代码与原作者资料库。更新前会检查本地改动和仓库分叉。")),
        ...
        react.createElement("div", { style: { marginTop: "10px", color: "var(--dsw-alias-label-tertiary)", fontSize: "11px", lineHeight: 1.5 } }, "更新插件代码后通常需要重新加载 DSH 插件；资料库更新不会覆盖您的角色卡项目。"));
    }
